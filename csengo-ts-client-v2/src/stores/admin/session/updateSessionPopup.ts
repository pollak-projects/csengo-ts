...
export const useUpdateSessionPopupStore = defineStore('updateSessionPopup', () => {
    const logger = serviceLogger('updateSessionStore');
    ...
    async function updateSession() {
        ...
        try {
            const response = await fetch(`${url}/api/voting-sessions?id=${session.value.id}`, {
                method: 'PUT',
                headers: {
