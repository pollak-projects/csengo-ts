...
CREATE ROLE csengo;
ALTER ROLE csengo WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:1duR039PFzEJkAsxsAqIsg==$6jJC7+w2c4bQDt/b6NSiR2AWgzRMCz5Iktqw9vHTQeM=:JvrkXdETQAhz+vwF7xYo3CcLvsgRdETi8f3GiL+0Rno=';
...
CREATE DATABASE csengo WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE csengo OWNER TO csengo;
